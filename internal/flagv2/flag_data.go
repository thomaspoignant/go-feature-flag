...
type FlagData struct {
	...
	//// DefaultVariation is the variation returned is the targeting is off.
	//DefaultVariation *string `json:"defaultVariation,omitempty" yaml:"defaultVariation,omitempty" toml:"defaultVariation,omitempty"`
...
func (f *FlagData) Value(flagName string, user ffuser.User, sdkDefaultValue interface{}) (interface{}, string) {
	...
	return *variations[variationName], variationName
}
