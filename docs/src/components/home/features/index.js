    ...
    <div className="grid grid-pad">
      ...
      <div className="col-1-2">
        <div className={clsx(styles.featureContent, "mr-25")}>
          ...
          <p>
            GO Feature Flag believe in OpenSource and offer providers for the new standard for feature flags <Link href={"https://openfeature.dev"}>OpenFeature</Link>.
          <br />
            In combination with the Open Feature SDK these <b>providers</b> will allow you to use GO Feature Flag with all
            supported languages.
          </p>
          <p>
