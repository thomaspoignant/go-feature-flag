...
- Storing your configuration flags file on various locations ([`HTTP`](./flag_file/http.md), [`S3`](./flag_file/s3.md), [`file`](./flag_file/file.md), [`kubernetes`](./flag_file/kubernetes_configmaps.md), and [more](./flag_file)).
