...
You can also lint/validate a GO Feature Flag configuration programmatically without using the CLI.
Check the [example repository](https://github.com/thomaspoignant/go-feature-flag/tree/main/examples/lint_flag_programmatically/README.md) to see how to do it in Go.
