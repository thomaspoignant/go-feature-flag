...
sidebar_position: 12
title: Angular
description: How to use the OpenFeature Javascript Angular SDK for your Angular application
---
...
## About this provider
OpenFeature Angular SDK allows you to connect to your GO Feature Flag instance with the `@openfeature/angular-sdk`.
