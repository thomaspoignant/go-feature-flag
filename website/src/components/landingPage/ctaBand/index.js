...
export default function CtaBand({title, description, actions}) {
  return (
    <section className="px-6 py-12 lg:px-16 xl:px-64 2xl:px-96">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-700 via-blue-600 to-sky-500 px-6 py-14 text-center shadow-lg">
        <div
          aria-hidden="true"
        ...
        {description && (
          <p className="relative mx-auto mt-4 max-w-2xl text-lg text-blue-50">
            {description}
          </p>
        )}
                ...
                <Link
                  ...
                  className={
                    secondary
                      ...
                      : 'inline-flex items-center gap-2 rounded-lg bg-white px-6 py-3 text-base font-semibold text-indigo-700 no-underline hover:bg-blue-50 hover:no-underline'
                  }>
                  {action.icon}
                  {action.label}
                </Link>
