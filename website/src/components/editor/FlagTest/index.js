...
export function FlagTest({flagInfo}) {
  ...
  const [data, setData] = useState({ resolutionDetail: undefined, err: undefined });
    ...
    <div>
      ...
      <div className="grid-pad grid">
        <div className="col-5-12">
          ...
          <JsonEditor label={`${flagInfo}.context`} value={JSON.stringify(defaultContext, " ", 2)}/>
        </div>
        ...
        <div className="col-5-12">
          ...
          <div>
            ...
            {data.err !== undefined && <span>Impossible to call the API: {data.err}</span> }
