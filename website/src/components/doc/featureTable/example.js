    ...
    const exampleSdk = {
        ...
        featureList: [
            ...
            },
            {
                ...
                status: 'done',
                description: 'A polling mechanism is in place to refresh the cache in case of configuration change'
            },
            {
                name: 'Logging',
            ...
            },
            {
                ...
                status: 'done',
                description: 'You can register to receive some internal event from the provider'
            },
            {
                name: 'Unit test',
                status: 'done',
                description: 'The test are running one by one, but we still have an issue open to enable fully the tests'
            }
        ]
    };
