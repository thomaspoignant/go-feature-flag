export const Vignette = ({ color, link, title, description, icon }) => {
    const colors = {
        cyan: {
            ...
            link: "inline-flex items-center mt-4 text-cyan-600 hover:text-cyan-800 dark:text-cyan-400 dark:hover:text-cyan-300 font-medium"
        },
        blue: {
            ...
            link: "inline-flex items-center mt-4 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-medium"
        },
    };
    ...
    return (
        <a href={link} className={colors[color].href}>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                This is the default way of using GO Feature Flag, it requires a minimum configuration and is easy to setup
            </p>
