...
| `openTelemetryOtlpEndpoint`        | string                                  | **none**    | Endpoint of your OpenTelemetry OTLP collector, used to send traces to it and you will be able to forward them to your OpenTelemetry solution with the appropriate provider. (deprecated, can be overridden with `$OTEL_EXPORTER_OTLP_ENDPOINT`)                                                                                                                                                                                                                                    |
