...
| `DisableNotifierOnInit`       | boolean                                | `false`            | If **true**, the relay proxy will not send a notification when the flags are loaded during initialization. This is useful if you do not want a Slack/Webhook notification saying that the flags have been added every time you start the proxy.<br/>Default: **false**                                                                                                                                                                                                         |
