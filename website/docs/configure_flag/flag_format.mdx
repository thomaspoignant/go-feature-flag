  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>
          ...
          data collection, you have to update it your self.
        </p>
        <p>
    ...
    <tr>
      ...
      <td>
        ...
        <p>
          You can add several steps that updates the flag, this is typically
    ...
    <tr>
      ...
      <td>
        <p>
          Experimentation allow you to configure a start date and an end date
