...
func (e evaluate) Evaluate() error {
	c := ffclient.Config{
	...
	return errors.New("invalid evaluation context (missing targeting key)")
}

func (e evaluate) evaluateSingleFlag(goff *ffclient.GoFeatureFlag, evalCtx ffcontext.Context, flag string) error {
...
func (e evaluate) evaluateBulk(goff *ffclient.GoFeatureFlag, evalCtx ffcontext.Context) error {
