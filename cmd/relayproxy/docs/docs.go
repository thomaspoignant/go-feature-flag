            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/model.ManifestSuccessResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                        "schema": {
                            "$ref": "#/definitions/model.ManifestError"
                        }
                    },
                    "403": {
        ...
        "/v1/flags": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Case-insensitive substring match on flag key",
                        "name": "q",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/model.FlagListResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "The flag to create",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/model.FlagResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/v1/flags/{flag_key}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "The full flag definition",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.SetFlagStateRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.DTO": {
            ...
            "properties": {
                ...
                "converter": {
                    "description": "Converter (optional) is the name of converter to use, if no converter specified we try to determine\nwhich converter to use based on the fields we receive for the flag",
                    "type": "string"
                },
                "defaultRule": {
                ...
                "scheduledRollout": {
                    "description": "Scheduled is your struct to configure an update on some fields of your flag over time.\nYou can add several steps that updates the flag, this is typically used if you want to gradually add more user\nin your flag.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/flag.ScheduledStep"
                    }
                },
                "targeting": {
        ...
        "dto.ExperimentationDto": {
            "type": "object",
            "properties": {
                "end": {
                    "description": "End is the ending time of the experimentation",
                    "type": "string"
                },
                "start": {
                    "description": "Start is the starting time of the experimentation",
                    "type": "string"
                }
            }
        },
        ...
        "flag.ProgressiveRollout": {
            ...
            "properties": {
                "end": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/flag.ProgressiveRolloutStep"
                        }
                    ]
                },
                "initial": {
        ...
        "flag.Rule": {
            ...
            "properties": {
                ...
                "progressiveRollout": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/flag.ProgressiveRollout"
                        }
                    ]
                },
                "query": {
                    "description": "Query represents the query used to target the audience of the flag.",
                    "type": "string"
                },
                "variation": {
        ...
        "flag.ScheduledStep": {
            ...
            "properties": {
                ...
                "defaultRule": {
                    "description": "DefaultRule is the originalRule applied after checking that any other rules\nmatched the user.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/flag.Rule"
                        }
                ...
                "experimentation": {
                    "description": "Experimentation is your struct to configure an experimentation, it will allow you to configure a start date and\nan end date for your flag.\nWhen the experimentation is not running, the flag will serve the default value.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/flag.ExperimentationRollout"
                        }
                    ]
                },
                "metadata": {
                ...
                "variations": {
                    "description": "Variations are all the variations available for this flag. You can have as many variation as needed.",
                    "type": "object",
                    "additionalProperties": {}
                },
                "version": {
        ...
        "github_com_thomaspoignant_go-feature-flag_cmd_relayproxy_model.FlagType": {
            "type": "string",
            "enum": [
                "boolean",
                "string",
        ...
        "github_com_thomaspoignant_go-feature-flag_cmdhelpers_manifest_model.FlagType": {
            "type": "string",
            "enum": [
                "boolean",
                "string",
        ...
        "model.FlagListResponse": {
            ...
            "properties": {
                ...
                "meta": {
                    "$ref": "#/definitions/model.FlagListMeta"
                }
            }
        },
        "model.FlagResponse": {
            ...
            "properties": {
                ...
                "editable": {
                    "description": "Editable is false when the owning retriever/flagset doesn't support writes.",
                    "type": "boolean"
                },
                "etag": {
                    "description": "ETag is the current revision; echo it back as If-Match on the next write.",
                    "type": "string"
                },
                "key": {
                    "type": "string"
                ...
                "source": {
                    "description": "Source is the retriever owning this flag, e.g. \"postgresql:go_feature_flag\".",
                    "type": "string"
                },
                "type": {
                    "$ref": "#/definitions/github_com_thomaspoignant_go-feature-flag_cmd_relayproxy_model.FlagType"
                }
            }
        },
        ...
        "model.ManifestDefinitionSuccessResponse": {
            "type": "object",
            "properties": {
                "defaultValue": {},
                "description": {
                ...
                "type": {
                    "$ref": "#/definitions/github_com_thomaspoignant_go-feature-flag_cmdhelpers_manifest_model.FlagType"
                }
            }
        },
        "model.ManifestError": {
            ...
            "properties": {
                "error": {
                    "$ref": "#/definitions/model.ManifestErrorDetails"
                }
            }
        },
        "model.ManifestErrorDetails": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string",
        ...
        "model.ManifestSuccessResponse": {
            "type": "object",
            "properties": {
                "flags": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.ManifestDefinitionSuccessResponse"
                    }
                }
            }
        },
