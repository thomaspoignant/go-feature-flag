...
<p align="center">
    ...
    <br />
    <a href="https://gofeatureflag.org">GO Feature Flag is a simple, complete and lightweight self-hosted cloud native feature flag solution 100% Open Source. 🎛️</a>
</p>
...
| Rust _(via OFREP)_             | [OpenFeature OFREP Provider](https://github.com/open-feature/rust-sdk-contrib/tree/main/crates/ofrep)                         | [![version](https://img.shields.io/crates/v/open-feature-ofrep?color=blue&style=flat-square&logo=rust)](https://crates.io/crates/open-feature-ofrep)                                                                                                                                                                                              |
